...
import {useProductManageSpecificationModel} from "@/views/productManage/specification/model";
const {getTableColumn, getSearchConfigs} = useProductManageSpecificationModel()

export default defineComponent({
  name: "productManageSpecification",
  components: {
    wTable,
    wSearch
  },
  ...
  setup(props, { attrs, slots, emit, expose }) {
      ...
      let arr:Array<any> = [
        {
          ...
          specificationName: '热卖',
          remark: '描述1123123'
        },
        {
          creatTime: '2016-05-01 14:02:22',
          specificationName: '秒杀',
          remark: '描述1123123'
        }
      ]
    ...
    return () => (
      <div class="product-manage-specification">
